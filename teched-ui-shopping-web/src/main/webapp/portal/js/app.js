...
function init() {
	...
	jQuery.sap.registerModulePath(sap.app.config.viewNamespace, getUrl(sap.app.config.viewNamespace));
	...
	if (sap.app.localStorage.getPreference(sap.app.localStorage.PREF_USE_ABAP_BACKEND)) {
		sap.app.odatamodel = new sap.ui.model.odata.ODataModel(host + "/teched-ui-shopping-web/" + "proxy/"
				+ sap.app.utility.getBackendDestination(), true);
	} else {
		sap.app.odatamodel = new ExtendedOdataModel(host + "/teched-ui-shopping-web/" + "proxy/"
				+ sap.app.utility.getBackendDestination(), true);
	}
	...
	sap.app.extensionodatamodel = new sap.ui.model.odata.ODataModel(host + "/teched-ui-shopping-web/" + "proxy/"
