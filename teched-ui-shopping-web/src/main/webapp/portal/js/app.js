...
{		
	...
	sap.app.extensionodatamodel = new sap.ui.model.odata.ODataModel((host + "/teched-ui-shopping-web/" +  + "/teched-ui-shopping-web/proxy/" + sap.app.utility.getExtensionBackendDestination()));
